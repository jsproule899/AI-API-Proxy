...
var ASM_CONSTS = {
  4539600: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4539661: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4539725: function() {return Module.webglContextAttributes.powerPreference;},  
 4539783: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4539838: function($0) {performance.now = function() { return $0; };},  
 4539886: function($0) {performance.now = function() { return $0; };},  
 4539934: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _JS_DeleteCookie(cookieNamePtr) {
  ...
  function _JS_GetCookie(cookieNamePtr) {
          cookieName = UTF8ToString(cookieNamePtr);
          let name = cookieName + "=";
  ...
  function _JS_SetCookie(cookieNamePtr, cookieValuePtr, expInDays) {
          cookieName = UTF8ToString(cookieNamePtr);
  ...
  function _JS_SpeechDetector_InitOrResumeContext() {
          if (!WEBAudio || WEBAudio.audioWebEnabled == 0) {
              // No WEBAudio object (Unity version changed?)
              return false;
          }
  ...
  function _JS_SpeechDetector_StopListening() {
          var sdCtx = document.speechDetectorContext;
  ...
  function _JS_SpeechDetector_checkForSpeech(delayInMilliseconds) {
          let maxVolume = -144.0
          var sdCtx = document.speechDetectorContext;
  ...
  function _JS_TextFile_Append(textToAppendPtr) {
          myInstance.textData.appendedContent.push(UTF8ToString(textToAppendPtr));
      }

  function _JS_TextFile_CreateBlob(filenamePtr) {
  ...
  function _JS_TextFile_CreateObject(initialTextPtr) {
          if (initialTextPtr) {
...
var asmLibraryArg = {
  ...
  "JS_DeleteCookie": _JS_DeleteCookie,
  ...
  "JS_GetBaseUrl": _JS_GetBaseUrl,
  "JS_GetCookie": _JS_GetCookie,
  "JS_GetCurrentUrl": _JS_GetCurrentUrl,
  "JS_GetUrlParams": _JS_GetUrlParams,
  "JS_GetUrlPath": _JS_GetUrlPath,
  ...
  "JS_SpeechDetector_InitOrResumeContext": _JS_SpeechDetector_InitOrResumeContext,
  "JS_SpeechDetector_StopListening": _JS_SpeechDetector_StopListening,
  "JS_SpeechDetector_checkForSpeech": _JS_SpeechDetector_checkForSpeech,
  ...
  "JS_TextFile_Append": _JS_TextFile_Append,
  "JS_TextFile_CreateBlob": _JS_TextFile_CreateBlob,
  "JS_TextFile_CreateObject": _JS_TextFile_CreateObject,
